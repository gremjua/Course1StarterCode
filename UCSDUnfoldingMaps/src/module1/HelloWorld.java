...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		size(windowWidth, 600, P2D);  // Set up the Applet window to be 800x600
		...
		final float mapWidth = 350;		//JUAN
		final float mapHeight = 500;
		...
		map2 = new UnfoldingMap(this, windowWidth-mapWidth-50, 50, mapWidth, mapHeight, provider);
		map2.zoomAndPanTo(zoomLevel,  new Location(-34.6083f, -58.3712f));
